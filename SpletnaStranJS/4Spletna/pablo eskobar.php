<?php                            #TO JE PHP dokument za glavno stran, do not delete yo!
    ...
    $Slika=get_image("../2Slike/Kriminalci/pablo eskobar.jpg", "img1 left");                 //Spremenlivka za sliko v podmeniju

    $Slika1=get_image("../2Slike/Kriminalci/pablo eskobar.jpg", "img6 right");                //Spremenlivka za sliko na Desni strani

    $Slika2=get_image("../2Slike/agencije/CIA.png", "img6 left");                //Spremenlivka za sliko na Levi strani


    $Agencija="AI capone";                                               //Ime agencije
    $Agent="znan diler";                                                  //Agent ali usmerjenost agencije
